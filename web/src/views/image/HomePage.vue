...
.image-homepage-container {
  ...
  background:
    radial-gradient(circle at top right, oklch(var(--a) / 0.05), transparent 28%),
    radial-gradient(circle at bottom left, oklch(var(--p) / 0.04), transparent 22%);
  ...
  .gifp-container {
    ...
    .gifp-content {
      ...
      .gifp-settings {
        ...
        background: linear-gradient(180deg, oklch(var(--b1) / 0.9), oklch(var(--b2) / 0.84)), oklch(var(--b1) / 0.7);
