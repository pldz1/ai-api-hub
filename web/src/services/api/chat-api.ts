 ...
 */
export const getChatListAPI = () => apiRequest("post", "/_api/chat/getChatList", {});

/**
 * 获取对话的模型设置参数
 * @return {Promise<{ flag: boolean, log: string, data:string }>} 服务器返回的结果
 */
export const getChatSettingsAPI = (cid) => apiRequest("post", "/_api/chat/getChatSettings", { cid });

/**
 * 设置对话的模型设置参数
 * @return {Promise<{ flag: boolean, log: string }>} 服务器返回的结果
 */
export const setChatSettingsAPI = (cid, data) => apiRequest("post", "/_api/chat/setChatSettings", { cid, data });

/**
 * 新增对话请求
 * @return {Promise<{ flag: boolean, log: string }>} 服务器返回的结果
 */
export const addChatAPI = (cid, cname) => apiRequest("post", "/_api/chat/addChat", { cid, cname });

/**
 * 删除对话
 * @return {Promise<{ flag: boolean, log: string }>} 服务器返回的结果
 */
export const deleteChatAPI = (cid) => apiRequest("post", "/_api/chat/deleteChat", { cid });

/**
 * 重命名对话
 * @return {Promise<{ flag: boolean, log: string }>} 服务器返回的结果
 */
export const renameChatAPI = (cid, cname) => apiRequest("post", "/_api/chat/renameChat", { cid, cname });

/**
 * 获得全部消息内容
 * @return {Promise<{ flag: boolean, log: string, data: any[]}>} 服务器返回的结果
 */
export const getAllMessageAPI = (cid) => apiRequest("post", "/_api/chat/getAllMessage", { cid });

/**
 * 新增消息
 * @return {Promise<{ flag: boolean, log: string }>} 服务器返回的结果
 */
export const addMessageAPI = (cid, mid, message) => apiRequest("post", "/_api/chat/addMessage", { cid, mid, message });
