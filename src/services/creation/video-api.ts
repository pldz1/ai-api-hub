...
export const getVideoListAPI = (): Promise<ApiResponse<VideoDataItem[]>> =>
  apiRequest("post", "/_api/video/getVideoList", {});
...
export const deleteVideoAPI = (id: string): Promise<ApiResponse<null>> =>
  apiRequest("post", "/_api/video/deleteVideo", { video_id: id });

export const getVideoConversationListAPI = (): Promise<ApiResponse<VideoConversationListItem[]>> =>
  apiRequest("post", "/_api/video/getConversationList", {});
...
export const deleteVideoConversationAPI = (vid: string): Promise<ApiResponse<null>> =>
  apiRequest("post", "/_api/video/deleteConversation", { vid });
...
export const setVideoConversationMessagesAPI = (
  vid: string,
  messages: unknown[],
