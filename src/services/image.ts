...
import { generateImageByProvider } from "@/services/image/providers";
import { apiRequest } from "@/services/storage";
import { dsAlert, getUuid } from "@/utils";
import type { ApiResponse, ImageConversationListItem, ImageDataItem, ImageGenerationParams, ImageProviderModel, TokenUsage } from "@/services/types";
...
const addImageConversationAPI = (iid: string, iname: string): Promise<ApiResponse<null>> =>
...
export async function generateImage(model: ImageProviderModel, params: ImageGenerationParams) {
