...
import type { ChatModelSettings, ConversationModelSnapshot, PersistedChatSettingsPayload } from "@/types";

type ConversationLike = {
  modelSnapshot?: ConversationModelSnapshot | null;
} | null;

type RawChatSettingsPayload = string | PersistedChatSettingsPayload | Partial<ChatModelSettings> | null;
...
export function createChatSettingsPayloadForSession(cid: string): PersistedChatSettingsPayload {
...
export function normalizeChatSettingsPayload(
  rawData: RawChatSettingsPayload,
  fallbackModel: ChatModelConfig | null = null,
): PersistedChatSettingsPayload {
