import type { ImageGenerationParams, ImageGenerationResult, ImageParamValue, ImageProviderModel, ImageRequest } from "../types";
...
export function hasImageInput(params: ImageRequestBody = {}): boolean {
...
export function buildImageFormData(body: ImageRequestBody = {}, options: { omitModel?: boolean } = {}): FormData {
